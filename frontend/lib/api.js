...
export async function editPlaces(data) {
    try {
        const response = await fetch(`${BASE_URL}/edit-places`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                place_id: data.place_id,
...
export async function editAttractions(data) {
    try {
        const response = await fetch(`${BASE_URL}/edit-attractions`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
...
export async function editRoadTrippers(data) {
    try {
        const response = await fetch(`${BASE_URL}/edit-road-trippers`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                road_tripper_id: data.road_tripper_id,
