...
-- `RoadTrippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RoadTrippers` (
  `road_tripper_id` INT NOT NULL AUTO_INCREMENT,
  `username` VARCHAR(255) NOT NULL,
  `email` VARCHAR(255) NOT NULL,
  `created_at` DATETIME NOT NULL,
  PRIMARY KEY (`road_tripper_id`),
  UNIQUE INDEX `road_tripper_id_UNIQUE` (`road_tripper_id` ASC) VISIBLE,
...
-- `RoadTripRoutes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RoadTripRoutes` (
  ...
  INDEX `road_tripper_id_idx` (`road_tripper_id` ASC) VISIBLE,
  UNIQUE INDEX `road_trip_id_UNIQUE` (`road_trip_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `TripBudgets` (
  ...
  UNIQUE INDEX `road_trip_id_UNIQUE` (`road_trip_id` ASC) VISIBLE,
  UNIQUE INDEX `trip_budget_id_UNIQUE` (`trip_budget_id` ASC) VISIBLE,
...
-- `RoadTripPlaces`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RoadTripPlaces` (
  `road_trip_place_id` INT NOT NULL AUTO_INCREMENT,
  `road_trip_id` INT NOT NULL,
  `place_id` INT NOT NULL,
  `stop_order` INT NOT NULL,
  PRIMARY KEY (`road_trip_place_id`),
  INDEX `road_trip_id_idx` (`road_trip_id` ASC) VISIBLE,
  UNIQUE INDEX `road_trip_place_id_UNIQUE` (`road_trip_place_id` ASC) VISIBLE,
